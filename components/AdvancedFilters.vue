      ...
      <div class="top-filters">
        ...
        <div class="filter-half">
          ...
          >
            ...
            <option v-for="(gen, key) in generations" :key="key" :value="key">
        ...
        <div class="type-filter-header">
          <div class="type-filter-title-group">
            <span class="filter-title">{{
              localFilterMode === 'type' ? 'Type filter' : 'Weakness filter'
            }}</span>
...
<script setup lang="ts">
  ...
  watch(
    () => props.rangeMin,
    (newValue) => {
      localRangeMin.value = newValue
    }
  )
  watch(
    () => props.rangeMax,
    (newValue) => {
      localRangeMax.value = newValue
    }
  )
  watch(
    () => props.selectedGeneration,
    (newValue) => {
      localSelectedGeneration.value = newValue
    }
  )
  watch(
    () => props.filterMode,
    (newValue) => {
      localFilterMode.value = newValue
    }
  )
